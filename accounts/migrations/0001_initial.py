    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('eleve', 'Élève'), ('prof', 'Professeur'), ('superviseur', 'Superviseur'), ('admin', 'Administrateur')], default='eleve', max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('statut', models.CharField(choices=[('actif', 'Actif'), ('suspendu', 'Suspendu'), ('ancien', 'Ancien'), ('nouveau', 'NOUVEAU')], default='actif', max_length=20)),
