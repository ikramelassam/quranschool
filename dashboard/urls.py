...
urlpatterns = [
    ...
    path('prof/hifz/<int:eleve_id>/modifier-direction/', views.prof_modifier_direction_hifz, name='prof_modifier_direction_hifz'),
    ...
    path('admin/programme-general/par-seances/ajouter/', views.admin_programme_general_par_seances_ajouter, name='admin_programme_general_par_seances_ajouter'),
    path('admin/programme-general/par-seances/<int:version_id>/modifier/', views.admin_programme_general_par_seances_modifier, name='admin_programme_general_par_seances_modifier'),
    path('admin/programme-general/par-seances/<int:version_id>/supprimer/', views.admin_programme_general_par_seances_supprimer, name='admin_programme_general_par_seances_supprimer'),
    ...
    path('admin/reglage-relance-whatsapp/', views.admin_reglage_relance_whatsapp, name='admin_reglage_relance_whatsapp'),
